                ...
                <div className="text-center w-full animate-fade-in">
                    {project.files && project.files.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-6 animate-pulse">
                            <i className="fas fa-spinner fa-spin text-prosas-blue text-4xl mb-3"></i>
                            <p className="text-sm text-gray-500 font-bold">Processando arquivos...</p>
                            <p className="text-xs text-gray-400 mt-2 text-center max-w-[200px]">Extraindo e carregando os documentos...</p>
                        </div>
                    ) : (
                        <div>
