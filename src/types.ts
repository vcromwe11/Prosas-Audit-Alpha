...
export interface AnalysisPoint {
  title: string;
  status: 'OK' | 'ERROR' | 'WARNING' | 'PENDENTE';
  evidence: string;
...
export interface AuditResult {
  ...
  overallStatus: 'APROVADO' | 'REPROVADO' | 'RESSALVAS' | 'INCOMPLETO';
  summary: string;
...
export interface EditalSettings {
  id: string; // The edital name
  context: Omit<AuditContext, 'isReady'>;
  updatedBy: string;
  timestamp: number;
}
