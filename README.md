...
Para garantir a rastreabilidade e governança corporativa da plataforma, o controle de acesso é rigidamente baseado em perfis de permissão (RBAC - Role-Based Access Control).
Existem três níveis de permissão em operação:
...
Ações permitidas:
Visualizar as métricas demonstrativas no Dashboard.
Navegar pelo histórico de editais e candidatos cadastrados.
Abrir e ler os relatórios de auditoria concluídos.
...
2. Auditor / Analista (analyst / auditor)
...
Ações permitidas:
Cadastrar novas áreas de análise e editais.
Configurar documentos, regras de habilitação e parâmetros de prompts.
Criar múltiplos slots presenciais de candidatos.
Disparar, cancelar ou reiniciar análises de conformidade de documentos.
Concluir pareceres e atualizar status de conformidade do relatório de auditoria.
